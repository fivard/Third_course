...
public class App extends JFrame {
    ...
    private static final JButton btnAddAuthor = new JButton("Add Author");
    private static final JButton btnAddBook = new JButton("Add Book");
    ...
    private static final Box bookPanel = Box.createVerticalBox();
    private static final Box authorPanel = Box.createVerticalBox();

    private static final JComboBox comboAuthor = new JComboBox();
    private static final JComboBox comboBook = new JComboBox();

    private static final JTextField textAuthorName = new JTextField(30);
    private static final JTextField textBookName = new JTextField(30);
    private static final JTextField textBookAuthorName = new JTextField(30);
    private static final JTextField textBookYear = new JTextField(30);
    ...
    private static void save() {
        if (editMode) {
            if (authorMode) {
                ...
                AuthorDTO author;
                author = client.authorFindByName(textBookAuthorName.getText());
                if (author == null) {
