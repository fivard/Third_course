  ...
  constructor(private oauthService: OAuthService, private userService: UserService, private router: Router) {
    this.oauthService.events
      .subscribe(() => {
        ...
        this.isUserAuthenticatedSubject$.next(hasValidAccessToken && this.roles.includes("USER"));
        this.isAdminAuthenticatedSubject$.next(hasValidAccessToken && this.roles.includes("ADMIN"));
